...
public class AngelPage {
    ...
    public static void sendEnter()  {
        waitForVisible(TestHelper.buttonGenerate);
        TestHelper.drv.findElement(By.xpath(TestHelper.siteName)).sendKeys(Keys.ENTER);
                //*[@name='site']
                TestHelper.slp(5);
        clickOnAlert();
    }
    ...
    public static String getPassword() {
        ...
        waitForVisible(TestHelper.passwordField);
        return TestHelper.drv.findElement(By.xpath(TestHelper.passwordField)).getAttribute("value");
        //input[@name='password']
    }
    ...
    public static String getSiteName() {
        return TestHelper.drv.findElement(By.xpath(TestHelper.siteName)).getAttribute("value");
                //*[@name='site']
    }
    ...
    public static boolean getEnabledSiteName() {
        return TestHelper.drv.findElement(By.xpath(TestHelper.siteName)).isEnabled();
        //*[@name='site']
    ...
    public static boolean getEnabledPassword() {
        return TestHelper.drv.findElement(By.xpath(TestHelper.passwordField)).isEnabled();
        //input[@name='password']
    }
